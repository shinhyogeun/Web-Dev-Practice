...
declare class ReactRefreshPlugin {
   ...
   */
  constructor(options?: import('@pmmmwh/react-refresh-webpack-plugin/types/types').ReactRefreshPluginOptions | undefined);
  /**
   * @readonly
   * @type {import('./types').NormalizedPluginOptions}
   */
  readonly options: import('@pmmmwh/react-refresh-webpack-plugin/types/types').NormalizedPluginOptions;
  /**
   * Applies the plugin.
